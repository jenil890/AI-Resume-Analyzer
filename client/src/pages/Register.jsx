...
import { BrainCircuit, User, Mail, Lock, Loader2, AlertCircle, ArrowLeft } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-dark-950 flex flex-col font-sans transition-colors duration-300 relative justify-center items-center px-6 py-12">
      {/* Back to Home Button */}
      ...
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-brand-500/5 blur-[100px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md p-8 sm:p-10 rounded-3xl border border-slate-200 dark:border-dark-800 bg-white/70 dark:bg-dark-900/60 backdrop-blur-md shadow-2xl relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1.5 font-medium">
            Get instant access to AI resume scanning reports
          </p>
        </div>
        ...
        <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-8 font-medium">
          ...
          <Link to="/login" className="text-brand-500 hover:text-brand-600 font-bold">
            Sign in
          </Link>
        </p>
      </div>
